...
function util.initMyHud()
	screen_width,screen_height = getScreenSize()
	my_hud_id = createHUD() 
	showHUD(my_hud_id,"主人,欢迎您回来,准备好了我们就开始吧~",hud_text_font_size,hud_text_color,hud_background_color,2,0,screen_width  * (1 - 0.12),screen_width * 0.7,screen_height  * 0.055)  
end
...
function util.hudToast(toastInfo)
	screen_width,screen_height = getScreenSize()
	showHUD(my_hud_id,toastInfo,hud_text_font_size,hud_text_color,hud_background_color,2,0,screen_width  * (1 - 0.12),screen_width * 0.7,screen_height  * 0.055)  
end
